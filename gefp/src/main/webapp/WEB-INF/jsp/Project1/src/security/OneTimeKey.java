...
public class OneTimeKey {
    ...
    {
        if( paramArrayOfByte1.length % paramArrayOfByte2.length != 0 ){ throw new RuntimeException(
            "The length of one-time key is wrong" ); }
    ...
    public static void printKey( byte[] paramArrayOfByte,
    ...
    public static void main( String[] paramArrayOfString ) throws Exception
    {
        ...
        {
            System.out.println( "original text is " + paramArrayOfString[i] );
            byte[] arrayOfByte2 = xor( paramArrayOfString[i].getBytes(),
                arrayOfByte1 );
            System.out.println( "encoded to " + new String( arrayOfByte2 ) );
            byte[] arrayOfByte3 = xor( arrayOfByte2, arrayOfByte1 );
            System.out.println( "decoded to " + new String( arrayOfByte3 ) );
        }
    }
}
